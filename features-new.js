...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set up feature interactions
    setupFeatureInteractions();
});

// Initialize the features page
...
function setupHoverEffects() {
    const interactiveItems = document.querySelectorAll('.feature-item');
...
function setupFeatureInteractions() {
    ...
    console.log('Features page interactions set up');
    
    // Add click tracking to all feature items
    const featureItems = document.querySelectorAll('.feature-item');
    
    featureItems.forEach(item => {
        item.addEventListener('click', function() {
            const featureName = this.querySelector('h4')?.textContent || 'Unknown';
            console.log('Feature clicked:', featureName);
            
            // Show feature details modal
            showFeatureModal(featureName, this.querySelector('p')?.textContent || '');
        });
    });
}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-actions">
                    <button class="modal-btn primary" onclick="closeFeatureModal()">Got it!</button>
                </div>
            </div>
        </div>
    `;
